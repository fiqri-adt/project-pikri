...
if ($input['action'] == 'edit') {
  ...
  if(isset($input['denom_kertas'])) {
    $update_field.= "denom_kertas='".$input['denom_kertas']."'";
  ...
  if($update_field && $input['id']) {
    $sql_query = $mysqli->query("UPDATE denom_kertas SET $update_field WHERE id_denom_kertas='" . $input['id'] . "'");
    // $sql_query = "UPDATE denom_kertas SET $update_field WHERE id_denom_kertas='" . $input['id'] . "'";
